                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="input-group m-b">
                            <select class="form-control m-b" name="selectCompany" id="">
                                <option value="Bryant Ranch Prepack">Bryant Ranch Prepack</option>
                                <option value="ECR Pharmaceuticals">ECR Pharmaceuticals</option>
                                <option value="Direct Rx">Direct Rx</option>
                                <option value="Hyland's">Hyland's</option>
                                <option value="Swiss-American Products">Swiss-American Products</option>
                            </select>
                            <span class="input-group-addon"> 
